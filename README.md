...
*   Hakkımızda ve Misyon/Vizyon Sayfaları:  Hakkımızda sayfasında BioScope Movie hakkında “Nedir Bu BioScope Movie?” başlıklı bir “hakkımızda” yazısı bulunur. Yazının devamında üç adet interaktif yazı kutucuğu daha vardır. Son bölümde ise “BioScope Movie Hakkında Neler Dediler” başlıklı bir kullanıcı yorumları bölümü göze çarpmaktadır. Yorumda bulunan isimler açıkcası kanaatimce oldukça etkileyici görünüyor! Misyon/Vizyon sayfası yine hakkımızda sayfasına çok benzer bir şekilde BioScope Movie’nin misyonu ve vizyonunu açıklayan ayrı iki yazı kutucuğu bulunur.
